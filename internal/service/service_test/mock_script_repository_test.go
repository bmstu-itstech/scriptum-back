...
func TestMockScriptRepository_CreateNew(t *testing.T) {
...
func TestMockScriptRepository_Script(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
...
func TestMockScriptRepository_Update(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
	testScriptRepository_Update(t, r)
}

func TestMockScriptRepository_Delete(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
	testScriptRepository_Delete(t, r)
}

func TestMockScriptRepository_UserScripts(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
...
func TestMockScriptRepository_PublicScripts(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
...
func TestMockScriptRepository_SearchPublicScripts(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
...
func TestMockScriptRepository_SearchUserScripts(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
	testScriptRepository_SearchUserScripts_NotFound(t, r)
	testScriptRepository_SearchUserScripts_Found(t, r)
}

func TestMockScriptRepository_MixedSearck(t *testing.T) {
	r, err := setUpMockScriptRepository()
	require.NoError(t, err)
...
func testScriptRepository_UserScripts_NotFound(t *testing.T, repo scripts.ScriptRepository) {
	...
	require.True(t, strings.Contains(err.Error(), "UserScripts"))
}
...
func testScriptRepository_PublicScripts_NotFound(t *testing.T, repo scripts.ScriptRepository) {
	...
	require.Error(t, err)
	require.Nil(t, scriptsFound)
	require.True(t, strings.Contains(err.Error(), "PublicScripts"))
}
